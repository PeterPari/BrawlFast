...
import X from "./b9dab46744d3ce6409d6fcdedf31b4f100e87fc2-index_bg.wasm";
var F = class {
  static {
    __name(this, "F");
  }
...
function K() {
  return { __proto__: null, "./index_bg.js": { __proto__: null, __wbg_Error_8c4e43fe74559d73: /* @__PURE__ */ __name(function(t, e) {
    ...
    let n = at(t, e, s.__wasm_bindgen_func_elem_1842, Z);
    return i(n);
...
__name(K, "K");
function Z(_2, t, e) {
  s.__wasm_bindgen_func_elem_1843(_2, t, i(e));
}
__name(Z, "Z");
function tt(_2, t, e, n) {
  s.__wasm_bindgen_func_elem_951(_2, t, i(e), i(n));
}
__name(tt, "tt");
var et = ["bytes"];
...
// .wrangler/tmp/bundle-slYrjU/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-slYrjU/middleware-loader.entry.ts
