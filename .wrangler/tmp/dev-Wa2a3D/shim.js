...
import X from "./88adea1559385b3c95608400b8145d8bc0d22b06-index_bg.wasm";
var F = class {
  static {
    __name(this, "F");
  }
...
function K() {
  return { __proto__: null, "./index_bg.js": { __proto__: null, __wbg_Error_8c4e43fe74559d73: /* @__PURE__ */ __name(function(t, e) {
    ...
    let n = at(t, e, s.__wasm_bindgen_func_elem_1789, Z);
    return i(n);
...
__name(K, "K");
function Z(_2, t, e) {
  s.__wasm_bindgen_func_elem_1790(_2, t, i(e));
}
__name(Z, "Z");
function tt(_2, t, e, n) {
  s.__wasm_bindgen_func_elem_899(_2, t, i(e), i(n));
}
__name(tt, "tt");
var et = ["bytes"];
...
// .wrangler/tmp/bundle-qlU7DB/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-qlU7DB/middleware-loader.entry.ts
